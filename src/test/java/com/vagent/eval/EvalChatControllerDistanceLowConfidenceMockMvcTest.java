...
@TestPropertySource(
        properties = {
            ...
            "vagent.eval.api.low-confidence-cosine-distance-threshold=0.25",
            "vagent.rag.enabled=true",
            "vagent.guardrails.reflection.enabled=false"
        })
class EvalChatControllerDistanceLowConfidenceMockMvcTest {
    ...
    @Test
    void weakTopHitDistanceTriggersClarify() throws Exception {
        ...
        var r =
                mockMvc.perform(
                                post("/api/v1/eval/chat")
                                        ...
                                        .content("{\"query\":\"hello world long\",\"mode\":\"EVAL\"}"))
                        ...
                        .andExpect(jsonPath("$.meta.low_confidence_reasons[0]").value("WEAK_TOP_HIT_DISTANCE"))
                        .andReturn();
